#!/bin/bash
set -e
echo "🚀 STAGE 1: Building Core Database & Engine..."

mkdir -p assets/js/core

# 1. СОЗДАНИЕ БАЗЫ ДАННЫХ (database.js)
cat > assets/js/core/database.js << 'DBCODE'
const DB = {
...
# 2. СОЗДАНИЕ ЯДРА (engine.js)
cat > assets/js/core/engine.js << 'ENGINECODE'
const Engine = {
...
echo "✅ Stage 1 Complete! Files created in assets/js/core/"
