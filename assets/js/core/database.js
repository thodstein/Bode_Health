// ТЗ §1.1: Полная база препаратов и параметров
export const DB = {
  substances: [
  ...
  esters: {
    ...
    'igf1': [ {id:'lr3', name:'LR3 (Длинный)', hl:24}, {id:'des', name:'DES (Короткий)', hl:0.5} ],
    'mgf': [ {id:'m', name:'MGF', hl:0.5}, {id:'peg', name:'PEG-MGF', hl:48} ]
  },

  // ТЗ §2.1: Матрица рисков 7x7
  riskMatrix: {
  ...
  supportProtocol: [
    ...
    { t:'🍳 Завтрак', items:[ {n:'Астрагал', d:'500мг', m:'Почки'}, {n:'Небилет', d:'2.5мг', m:'Давление'}, {n:'Тадалафил', d:'5мг', m:'Поток'}, {n:'Берберин', d:'500мг', m:'Инсулин'}, {n:'D3+K2', d:'5000МЕ', m:'Кости'}, {n:'TMG', d:'1г', m:'Метил'}, {n:'Бергамот', d:'500мг', m:'Липиды'}, {n:'Бромантан', d:'50мг', m:'Дофамин'} ] },
  ...
  articles: [
    { id: 1, title: 'Основы PK/PD', category: 'Theory', views: 120 },
    { id: 2, title: 'Защита печени', category: 'Safety', views: 340 },
    { id: 3, title: 'IGF-1: LR3 vs DES', category: 'Peptides', views: 85 },
    { id: 4, title: 'Контроль Эстрадиола', category: 'Hormones', views: 210 }
  ],

  shopItems: {
    'udca': [ { platform: 'Ozon', price: '1500₽' }, { platform: 'iHerb', price: '$25' } ],
    'telmisartan': [ { platform: 'Apteka', price: '600₽' } ],
    'berberine': [ { platform: 'iHerb', price: '$20' } ]
  },
