const DB = {
    ...
    shop: {
        'udca': [{p:'Ozon',pr:'1500р'}], 'telmisartan': [{p:'Apteka',pr:'600р'}],
        'berberine': [{p:'iHerb',pr:'20$'}], 'taurine': [{p:'Ozon',pr:'800р'}]
    },
    articles: [
        {t:'Основы PK/PD', c:'Theory', v:120}, {t:'Защита печени', c:'Safety', v:340},
        {t:'IGF-1 LR3 vs DES', c:'Peptides', v:85}, {t:'Контроль Эстрадиола', c:'Hormones', v:210}
    ],
